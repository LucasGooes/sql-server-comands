/*TSL É UM BLOCO DE LINGUAGEM DE PROGRAMAÇÃO
	PROGRAMAS SÃO UNIDADES QUE PODEM SER CHAMADAS DE BLOCOS ANÔNIMOS. bLOCOS ANÔNIMOS NÃO RECEBEM NOME, POIS NÃO SÃO SALVOS NO BANCO.
...
BEGIN
	...
	ELSE
		PRINT 'O VALOR É FALOR'
END
GO

/*CASE - NÃO É EXCLUSIVAMENTE UM CLAUSULA DE PROGRAMAÇÃO*/
DECLARE
	@CONTADOR INT
BEGIN
